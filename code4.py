...
import math
import time
import pyautogui as pag#to give commands to keyboards to the screen above on desktop
import sys
import pygame
import time 
import os 
import subprocess
import pyglet#used for colors and font
import tkinter#gui screen is made with this package 
from tkinter import *
from os import path
...
x = Label(root,text="Press the button below to run the application.")
#x.config(width=75)
